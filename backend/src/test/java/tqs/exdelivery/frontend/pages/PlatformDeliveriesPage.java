...
public class PlatformDeliveriesPage {
    ...
    public void insertOrder(String sortOrder) {
        ...
        {
            WebElement element = driver.findElement(By.cssSelector(".MuiButtonBase-root:nth-child("+ sortOption +")"));
            Actions builder = new Actions(driver);
    ...
    public void checkDeliveriesMoreThanOne() {
        {
            List<WebElement> elements = driver.findElements(By.cssSelector(".MuiTableRow-hover:nth-child(1) > .MuiTableCell-root:nth-child(1)"));
